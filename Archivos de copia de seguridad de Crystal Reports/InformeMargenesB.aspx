<%@ Page Language="VB" MasterPageFile="~/PRESENTACION/Principal.master" AutoEventWireup="false" CodeFile="InformeMargenesB.aspx.vb" Inherits="PRESENTACION_Mantenedores_MantenedorCargos" title="Untitled Page" %>
                    ...
                    <tr>
                        <td style="height: 34px;" colspan="3">
                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" 
                                ForeColor="Maroon" Text="Margen Bruto por Centro de Costo"></asp:Label>
                        </td>
                    </tr>
                    <tr>
