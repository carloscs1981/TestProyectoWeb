<%@ Page Language="VB" MasterPageFile="~/PRESENTACION/Principal.master" AutoEventWireup="false" CodeFile="MantenedorCompañias.aspx.vb" Inherits="PRESENTACION_Mantenedores_MantenedorCompañias" title="Mantenedor de Compañias" %>
        ...
        <tr>
            <td style="vertical-align: middle; width: 233px; height: 64px; background-color: lightyellow;
                ...
                <table style="width: 499px">
                    <tr>
                        <td>
                            <asp:TextBox ID="txtIdCompañia" runat="server" Width="27px">0</asp:TextBox></td>
                        <td>
                        </td>
                        <td>
                        </td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblNombre" runat="server" Text="Codigo Compañia :"></asp:Label>
                            <asp:TextBox ID="txtCodCompañia" runat="server" BackColor="white" BorderColor="Black"
                                BorderStyle="Inset" BorderWidth="1px" Style="background-color: white" Width="84px"></asp:TextBox></td>
                        <td>
                            <asp:Label ID="lblApellido" runat="server" Text="Nombre Compañia :"></asp:Label>
                            <asp:TextBox ID="txtTipoCompañia" runat="server" BorderColor="Black" BorderWidth="1px"
