<%@ Page Language="VB" MasterPageFile="~/PRESENTACION/Principal.master" AutoEventWireup="false" CodeFile="MantenedorContratos.aspx.vb" Inherits="PRESENTACION_Mantenedores_MantenedorContratos" title="Mantenedor de Contratos" %>
        ...
        <tr>
            <td style="vertical-align: middle; width: 233px; height: 64px; background-color: lightyellow;
                ...
                <table style="width: 499px">
                    <tr>
                        <td>
                            <asp:TextBox ID="txtIdContrato" runat="server" Width="27px">0</asp:TextBox></td>
                        <td>
                        </td>
                        <td>
                        </td>
