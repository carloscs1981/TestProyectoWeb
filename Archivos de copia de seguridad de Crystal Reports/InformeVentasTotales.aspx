<%@ Page Language="VB" MasterPageFile="~/PRESENTACION/Principal.master" AutoEventWireup="false" CodeFile="InformeVentasTotales.aspx.vb" Inherits="PRESENTACION_Mantenedores_MantenedorCargos" title="Untitled Page" %>
        ...
        <tr>
            ...
            <td align="center" 
                ...
                <table style="width: 635px; background-color: #C0C0C0; height: 82px;">
                    <tr>
                        <td style="height: 34px; background-color: #999999;" colspan="3">
                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" 
                                ForeColor="Maroon" Text="Ventas Totales"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 242px; height: 34px;">
                            <asp:Button ID="Button1" runat="server" Text="Exportar a Excel" Width="164px" 
                                Height="26px" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 242px; height: 2px;">
                            &nbsp;</td>
                        <td style="height: 2px; width: 146px" title="Ventas Totales">
                            </td>
                    </tr>
                    <tr>
            ...
            <td>
                <CR:CrystalReportViewer ID="VisorReporteVCC" runat="server" 
                    AutoDataBind="true" DisplayGroupTree="False" HasExportButton="False" 
                                ...
                                HasSearchButton="False" Height="50px" 
