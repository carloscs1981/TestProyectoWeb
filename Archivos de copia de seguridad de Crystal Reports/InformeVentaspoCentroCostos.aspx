<%@ Page Language="VB" MasterPageFile="~/PRESENTACION/Principal.master" AutoEventWireup="false" CodeFile="InformeVentaspoCentroCostos.aspx.vb" Inherits="PRESENTACION_Mantenedores_MantenedorCargos" title="Untitled Page" %>
...
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                    ...
                    <tr>
                        <td style="height: 34px;" colspan="3">
                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" 
                                ForeColor="Maroon" Text="Informe Ventas por Centro de Costo"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr align="center">
                        ...
                        <td style="width: 157px">
                            <asp:DataGrid ID="DataGrid1" runat="server" CellPadding="3" GridLines="None"
                                ...
                                <ItemStyle BackColor="#DEDFDE" ForeColor="Black" Font-Bold="False" 
                                    Font-Italic="False" Font-Overline="False" Font-Strikeout="False" 
    ...
    <table style="width: 169%; height: 1047px;">
        <tr>
            <td style="height: 208px; width: 635px; text-align: center;">
                <CR:CrystalReportViewer ID="VisorReporteVCC" runat="server" 
                    AutoDataBind="True" DisplayGroupTree="False" HasExportButton="False" 
                                HasGotoPageButton="False" HasPageNavigationButtons="False" 
                                HasSearchButton="False" Height="1039px" 
                    HasToggleGroupTreeButton="False" HasViewList="False" 
                    HasZoomFactorList="False" ReportSourceID="CrystalReportSource" 
                    Width="917px" Visible="False" />
                        </td>
        </tr>
        <tr>
            <td style="width: 635px">
                        <CR:CrystalReportSource ID="CrystalReportSource" runat="server">
                            <Report FileName="E:\Proyecto SN CHILE\ASP\Administracion de Redes\Administracion_Library\Reportes\rptVentasCentroCosto.rpt">
                            </Report>
