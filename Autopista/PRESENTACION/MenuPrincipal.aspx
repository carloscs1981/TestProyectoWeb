<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MenuPrincipal.aspx.vb" Inherits="PRESENTACION_MenuPrincipal" %>
                    ...
                    <table style="width: 27%;">
                        <tr>
                            <td class="auto-style5" style="background-color: #FFFFFF; empty-cells: hide; text-align: center;">
                                                            <asp:ImageButton ID="btnIngresoIncidente" runat="server" EnableTheming="True" Height="92px" ImageUrl="~/RECURSOS/Informe 1.jpg" Width="94px" BorderWidth="0px" style="text-align: center" />
                                    <asp:Label ID="Label6" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Ingreso Incidente" Width="104px"></asp:Label>
                            </td>
                            <td class="auto-style3" style="background-color: #FFFFFF; text-align: center;">
                                                            <asp:ImageButton ID="ImgPanelAdministracion" runat="server" Height="88px" ImageUrl="~/RECURSOS/images/Panel de Control.png" Width="102px" style="text-align: center" />
                                    <asp:Label ID="lblPanelAdministracion" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Panel Administración" Width="123px"></asp:Label>
                            </td>
                            <td class="auto-style4" style="background-color: #FFFFFF; text-align: center;">
                                                            <asp:ImageButton ID="ImageButton6" runat="server" Height="88px" ImageUrl="~/RECURSOS/informes.gif" Width="102px" />
                                    <asp:Label ID="Label8" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Informes" Width="82px"></asp:Label>
                            </td>
