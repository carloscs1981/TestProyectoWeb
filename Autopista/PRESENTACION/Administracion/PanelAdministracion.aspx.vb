...
Partial Class PRESENTACION_MenuPrincipal
    ...
    End Sub
    Protected Sub btnUsuarios_Click(sender As Object, e As ImageClickEventArgs) Handles btnUsuarios.Click
        Response.Redirect("User.aspx", False)
    End Sub
    Protected Sub ImageButton3_Click(sender As Object, e As ImageClickEventArgs) Handles ImgBtnVolver.Click
